 ...
 */
/***************************************************************
ADDED BPredPerceptron in bpred_class
****************************************************************/
...
enum bpred_class {
  ...
  BPredPerceptron,	// Added now..(1) /////////////////////////////////////////////////////////////////////////////////
  BPred3bit,		// Added now..(2) ////////////////////////////////////////////////////////////////////////////
  BPredlocal,           // Added now..(3) /////////////////////////////////////////////////////////////////////////////////
  BPrednbit,    /// added now .... (4\)/////////////////////////////////////////////////////////////////////////  
	BPred_NUM
};
  ...
  union {
    ...
    struct {
      ...
      unsigned char *table;	/* prediction state table */
		...
		struct {
      unsigned int size;	/* number of entries in direct-mapped table */
			unsigned int nbit_predictor; ///////////////// number of bits......
      unsigned char *table;	/* prediction state table */
    } nmod; /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    struct {
    ...
    struct {/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      int l1size;		/* level-1 size, number of history regs */
      int l2size;		/* level-2 size, number of pred states */
      int l1_width;		/* amount of history in level-1 shift regs */
      int merge;			/* merge value */
      unsigned char *l1table;		/* level-1 history table */
      unsigned char *l2table;	/* level-2 prediction state table */
    } local;
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     struct {
...
struct bpred_t {
  ...
  } dirpred;      /// need to check ki update karna hai ya nahi...structure ko...
